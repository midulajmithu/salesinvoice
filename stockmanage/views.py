...
def dashbord(request):
    if request.POST:
        ...
        detail_obj=P_S_Info(SorP=SorP,date=date,mr_mh_no=mr_mh_no,item=item,unit_of_measure=unit_of_measure,quantity=quantity,supplier_name=supplier_name,project_no=project_no,invoice_no=invoice_no)
        detail_obj.save()
